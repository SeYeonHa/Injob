			...
			<section class="box align_right">
				<aside class="box-sidebar">
					<div class="container-123">
						<hr>
						<a href="/Mypage/UserInfo?user_id=1" class="link"
							style="width: 150px;">회원 정보</a>
						<hr>
						<a href="/Mypage/Resume?user_id=1" class="link">이력서 관리</a>
						<hr>
						<a href="/Mypage/Bookmark?user_id=1" class="link">북마크</a>
						<hr>
						<a href="/Mypage/ApplyHistory?user_id=1" class="link">지원 이력</a>
						<hr>
					</div>
				</aside>
				...
				<div class="box-contents">
					<div class=" mx-2 pb-4 w-80">
						<c:forEach var="list" items="${list}">
							<div class="border2 border-tertiary p-5 rounded shadow">
								<h1 class="mar-10">이력서 제목 : ${ list.re_title }</h1>
								...
								<div class="d-flex justify-content-center">
									...
									<button type="button" class="btn btn-block btn-primary"
										onclick="location.href=`/Mypage/ResumeUpdate?user1&re_id=${list.re_id}`">
										수정하기</button>
									<!-- 삭제 버튼 -->
